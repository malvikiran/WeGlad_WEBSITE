...
if(!array_key_exists("yaml.hotel",$settings)) {
    printf("{yaml.hotel} key is not defined in settings. Aborting");
    exit ;
}

$index_yaml = $settings["yaml.hotel"];
    ...
    <div class="col-lg-offset-1 col-lg-11">
        <nav class="navbar navbar-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand"  style="font-weight: bold" href="hotel.php">Hotel</a>
